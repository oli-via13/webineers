  ...
  return (
    <>
      ...
      <div className='h-screen flex gap-2 justify-center items-center'>
            ...
            <div className='bg-white shadow-lg rounded-xl border-2 mb-2 w-70 h-30'>
              <h2 className='font-bold text-blue-600 text-2xl ml-3'> Streak</h2>
              <div className='flex'>
                <img className='-mt-10' src={gambar2} alt="" />
                <h2 className='font-bold text-blue-600 text-5xl'> 100</h2>
              </div>
            </div>
      
            <div className='bg-white shadow-lg rounded-xl border-2 mb-2 w-70 h-30'>
              <h2 className='font-bold text-blue-600 ml-3 text-2xl'> Following</h2>
              <div className='text-center'>
                <h2 className='font-bold text-blue-600 text-5xl mt-2'> 155</h2>
              </div>
            </div>
          </div>
